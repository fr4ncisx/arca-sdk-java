...
/**
 * Domain record representing the query parameters required to consult a CAEA code from ARCA.
 * <p>
 * According to AFIP regulations, the query must identify the target calendar month in
 ...
 * @since 0.4.0-M1
 */
public record CaeaQuery(int period, int order) {

    /**
     * Standard compact constructor validating CAEA query parameters.
     *

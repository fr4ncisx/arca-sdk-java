...
import io.github.fr4ncisx.arca.wsfev1.model.VoucherConsultResponse;
...
public final class GetVoucherUseCase {
    ...
    public VoucherConsultResponse execute(VoucherConsultRequest request) {
        ...
        FECompConsultar soapRequest = WsfeRequestMapper.toSoapRequest(auth, request);

        FECompConsultaResponse soapResponse = soapPort.invoke(soapRequest);
        return WsfeResponseMapper.toDomainResponse(soapResponse);
    }
}
